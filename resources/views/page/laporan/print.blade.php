                ...
                <table class="border border-1 border-black w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-1 border-black">KODE PENJUALAN</th>
                            <th class="border border-1 border-black">TANGGAL</th>
                            <th class="border border-1 border-black">KONSUMEN</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $d)
                            ...
                            <tr>
                                ...
                                <td class="border border-1 border-black text-left pl-2">{{ $d->kode_penjualan }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->tgl_penjualan }}</td>
                                <td class="border border-1 border-black">{{ $d->konsumen->nama_konsumen }}</td>
                                <td class="border border-1 border-black">{{ $d->total_bayar }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
